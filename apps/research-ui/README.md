...
opens the installed Brave Browser without taking focus away from Origin Trace.
This does not start a live capture session; use `make live` for the pinned
custom Brave capture workflow.
