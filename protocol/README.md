...
wake-ups, not individual events. Browser-to-broker delivery uses the same exact
records over a user-only Unix socket. Before records are accepted, Brave sends
