...
CHECK_WIRE_ENUM_VALUE(reb::EventType, reb::NativeProbeType, kVmFinding);
CHECK_WIRE_ENUM_VALUE(reb::EventType, reb::NativeProbeType, kArtifactCaptured);
CHECK_WIRE_ENUM_VALUE(reb::EventType, reb::NativeProbeType, kArtifactCaptureFailed);
