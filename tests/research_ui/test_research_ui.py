...
const hooksIdle = {
  ...
  field_test: {protocol_version: 2, enabled: false, url: '', method: 'POST', kind: 'json', pointer: '',
    observations: [], observation_evictions: 0, comparison: null,
    limits: {body_bytes: 131072, pointer_bytes: 256, preview_bytes: 256, observations: 16}},
...
const workerRequest = {id: 1, occurred_at_ms: 6, target_id: 'worker-1', target_type: 'worker',
...
process.stdout.write(JSON.stringify({
  ...
  hooksFieldMissingRejected: !isRuntimeHooks({...hooksReady, field_test: undefined}),
  hooksFieldDigestRejected: !isRuntimeHooks({...hooksReady, field_test: {...hooksReady.field_test,
    enabled: true, url: 'https://checkout.test/api/submit', pointer: '/payload',
    observations: [{id: 1, occurred_at_ms: 6, target_id: 'worker-1', request_id: 'request-1',
      url: 'https://checkout.test/api/submit', method: 'POST', related_hit_ids: [],
      status: 'available', sha256: 'not-a-digest', preview: 'x', bytes: 3}]}}),
...
"""
        ...
        self.assertEqual(
            json.loads(completed.stdout),
            {
                ...
                "hooksFieldMissingRejected": True,
                "hooksFieldDigestRejected": True,
...
"""
    ...
    def test_native_application_uses_the_packaged_icon(self) -> None:
        ...
        self.assertEqual(plist_values["CFBundleShortVersionString"], "0.2.1")
        self.assertEqual(plist_values["CFBundleVersion"], "21")
